  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          <span className="font-mono text-[11px] tracking-[0.3em] uppercase text-accent block mb-1">ATALHOS</span>
          <h1 className="font-display font-bold text-xl tracking-tighter text-white uppercase">Respostas Rapidas</h1>
        ...
        {!edit && (
          <button
            onClick={startCreate}
            className="shrink-0 flex items-center gap-2 bg-accent text-white rounded-lg px-5 py-2 text-sm font-display font-semibold uppercase tracking-wider shadow-[0_0_20px_rgba(255,59,0,0.25)] hover:shadow-[0_0_30px_rgba(255,59,0,0.4)] transition-all"
          >
            <Plus size={14} />
            Nova resposta
          </button>
