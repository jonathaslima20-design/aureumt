  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-3 border border-[#1a1a1a] rounded-xl bg-[#0a0a0a] p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="text-neutral-500 hover:text-white transition-colors p-2 rounded-lg border border-[#1a1a1a] hover:border-[#262626]"
          ...
          <div className="flex gap-2">
            {!isConnected ? (
              ...
              <button
                ...
                disabled={loading}
                className="flex-1 bg-[#0a0a0a] border border-[#1a1a1a] text-white rounded-lg py-2.5 text-sm font-medium flex items-center justify-center gap-2 hover:bg-[#151515] transition-colors disabled:opacity-50"
              >
        ...
        <div className="lg:col-span-2 border border-[#1a1a1a] rounded-xl bg-[#0a0a0a] p-6">
          ...
          <ol className="space-y-4 text-sm text-neutral-300">
            {[
              ...
              <li key={idx} className="flex gap-3">
                <span className="shrink-0 w-6 h-6 rounded-full border border-[#262626] flex items-center justify-center text-[11px] text-neutral-400 font-medium">
                  {idx + 1}
                </span>
