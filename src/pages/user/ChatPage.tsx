...
export function ChatPage({ instance }: { instance: Instance }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border border-[#242424] rounded-xl bg-[#141414] overflow-hidden grid grid-cols-1 md:grid-cols-3 h-[calc(100vh-220px)]">
        <div className="border-r border-[#242424] flex flex-col">
        ...
        <div className="md:col-span-2 flex flex-col">
          {!selected ? (
            ...
            <>
              ...
              <div
                ref={threadRef}
                className="flex-1 overflow-y-auto scrollbar-thin p-4 space-y-3 bg-[#0a0a0a]"
              >
                {loadingThread ? (
