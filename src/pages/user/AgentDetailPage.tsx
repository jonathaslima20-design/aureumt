...
function ProfileTab({ instance, onUpdate }: { instance: Instance; onUpdate: () => void }) {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <div className="bg-[#141414] border border-[#242424] rounded-2xl p-6 space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="border border-[#242424] hover:border-[#2e2e2e] text-neutral-300 hover:text-white rounded-lg px-4 py-2.5 text-sm flex items-center gap-2 transition-colors"
        >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="border border-[#242424] rounded-xl bg-[#141414] p-6 h-fit">
